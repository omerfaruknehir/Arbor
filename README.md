...
1. Download `Arbor-0.20.12-release.apk` from the [latest GitHub Release](https://github.com/omerfaruknehir/Arbor/releases/latest).
...
- [Latest release notes](docs/releases/RELEASE_NOTES_0.20.12.md)
