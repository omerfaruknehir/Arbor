...
- The Xylune mark in the navigation drawer now uses the exact same palette-specific artwork as the selected launcher icon.
- The Xylune entry in Offline licenses follows the active launcher icon instead of staying on the default green asset.
