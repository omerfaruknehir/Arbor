...
The release preserves `app.xylune.chat.debug`, Room schema and migrations, user data, credentials, workspaces, attachments, and the existing debug signer.
