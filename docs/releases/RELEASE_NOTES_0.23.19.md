...
The preference is stored persistently and included in portable settings backups and restoration, with older backups defaulting safely to the enabled state.
