...
Artifact checks confirmed a non-empty debug APK and AAB, ZIP integrity, debug APK application ID `app.arbor.chat.debug`, version code 77, version name `0.17.0-debug`, and a valid Android debug signature.
