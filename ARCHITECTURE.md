...
| Context | Complete newest request/answer groups bounded by pair, estimated-token, prompt, summary, attachment, and OCR limits; interrupted state is retained for resume |
...
| Agent tools | Portable fenced protocol; direct Python, Ubuntu commands, DuckDuckGo HTML search, and explicit ordered file sending; encrypted tool traces |
