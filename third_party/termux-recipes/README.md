...
whose binaries Arbor redistributes. They are historical upstream recipes, not
Arbor's authoritative license classification.
...
shared C library shipped by Arbor as LGPL-3.0-or-later.

Do not edit a retained recipe merely to make its metadata agree with Arbor's
