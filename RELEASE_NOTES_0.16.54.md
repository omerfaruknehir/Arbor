...
- Auto-follow now distinguishes a real finger drag from Arbor's own programmatic scrolling, reattaches on immediate send, and catches up at a capped smooth velocity instead of jumping to the last item.
