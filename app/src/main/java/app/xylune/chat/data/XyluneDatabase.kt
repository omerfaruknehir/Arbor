...
abstract class XyluneDatabase : RoomDatabase() {
    ...
    companion object {
        fun create(context: Context, passphrase: ByteArray): XyluneDatabase {
            System.loadLibrary("sqlcipher")
            val factory = SupportOpenHelperFactory(passphrase)
            return Room.databaseBuilder(context, XyluneDatabase::class.java, "xylune.db")
