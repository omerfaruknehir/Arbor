...
/** Applies the icon in the isolated process, then reopens the saved Xylune session. */
class LauncherIconSwitchReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        Thread {
            ...
            try {
                // PackageManager changes can kill every Xylune process on some One UI builds.
