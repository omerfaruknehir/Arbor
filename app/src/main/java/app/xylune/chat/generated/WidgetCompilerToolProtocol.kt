...
object WidgetCompilerToolProtocol {
    const val RESULT_SCHEMA = "xylune-widget-compiler-result/1"
        ...
        return WidgetCompilerToolResult(
            ...
            instruction = when {
                compilation.valid && rewritten != null ->
                    "Compilation passed. Emit exactly compiledSource, unchanged, inside one xylune-widget fence. Do not regenerate or edit it after this successful call."
                compilation.valid ->
                    "Compilation passed. Emit exactly the source argument from this successful call, unchanged, inside one xylune-widget fence. Do not regenerate or edit it after this successful call."
                else ->
                    "Compilation failed. Do not emit an xylune-widget block yet. Fix every diagnostic in the complete candidate and call compile_widget again." +
