package app.xylune.chat.ui.theme
...
private val XyluneLight = lightColorScheme(
...
private val XyluneDark = darkColorScheme(
...
private val GraphiteLight = XyluneLight.copy(
...
private val GraphiteDark = XyluneDark.copy(
...
private val OceanLight = XyluneLight.copy(
...
private val OceanDark = XyluneDark.copy(
...
private val VioletLight = XyluneLight.copy(
...
private val VioletDark = XyluneDark.copy(
...
private val SunsetLight = XyluneLight.copy(
...
private val SunsetDark = XyluneDark.copy(
...
internal fun paletteColorScheme(
    ...
    ColorPalette.XYLUNE -> if (dark) XyluneDark else XyluneLight
    ...
    } else if (dark) XyluneDark else XyluneLight
}
...
internal fun resolvedXyluneColorScheme(
    context: Context,
    palette: ColorPalette,
    themeMode: ThemeMode,
    amoled: Boolean,
...
fun palettePreviewColors(
    ...
    val scheme = resolvedXyluneColorScheme(context, palette, themeMode, amoled = false)
...
private val XyluneShapes = Shapes(
...
fun XyluneTheme(
    ...
    palette: ColorPalette = ColorPalette.XYLUNE,
    themeMode: ThemeMode = ThemeMode.SYSTEM,
    content: @Composable () -> Unit,
) {
    val context = LocalContext.current
    val dark = resolvedDarkMode(context, themeMode)
    val colors = resolvedXyluneColorScheme(context, palette, themeMode, amoled)
    val activity = context as? Activity
    activity?.window?.let {
        WindowCompat.getInsetsController(it, it.decorView).isAppearanceLightStatusBars = !dark
    }
    MaterialTheme(colorScheme = colors, shapes = XyluneShapes, content = content)
}
