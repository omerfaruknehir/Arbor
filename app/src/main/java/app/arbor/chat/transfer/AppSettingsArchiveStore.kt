...
private const val PORTABLE_SETTINGS_SCHEMA = "arbor-portable-settings-v1"
...
class AppSettingsArchiveStore(
    ...
    suspend fun restore(value: PortableAppSettings): AppSettingsRestoreResult {
        require(value.schema == PORTABLE_SETTINGS_SCHEMA) { "Unsupported Arbor settings backup" }
    ...
    private fun restorePreferences(
        ...
        preferences.setPalette(value.palette.enumOr(ColorPalette.ARBOR))
    ...
    private companion object {
        const val LINUX_PREFERENCES = "arbor_linux_runtime"
