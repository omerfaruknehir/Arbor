...
/**
 * Central haptic vocabulary for Arbor.
 *
 ...
 */
@Stable
class ArborHapticController internal constructor(private val view: View) {
...
@Composable
fun rememberArborHaptics(): ArborHapticController {
    val view = LocalView.current
    return remember(view) { ArborHapticController(view) }
}
