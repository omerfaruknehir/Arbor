...
@Composable
private fun ArborPopupBackHandler(onDismissRequest: () -> Unit) {
 ...
 * pointer stream when Android takes over an edge Back gesture. Arbor waits for
...
internal fun ReleaseDismissOutsideLayer(
    ...
    ArborPopupBackHandler(onDismissRequest)
    Popup(
