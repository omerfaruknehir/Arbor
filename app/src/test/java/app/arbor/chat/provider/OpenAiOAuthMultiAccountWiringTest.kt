...
class OpenAiOAuthMultiAccountWiringTest {
    ...
    fun oauthSessionsAndRequestsAreKeyedByProviderId() {
        val manager = java.io.File("src/main/java/app/arbor/chat/provider/OpenAiOAuthManager.kt").readText()
        val provider = java.io.File("src/main/java/app/arbor/chat/provider/OpenAiOAuthProvider.kt").readText()
        val secureStore = java.io.File("src/main/java/app/arbor/chat/security/SecureStore.kt").readText()
