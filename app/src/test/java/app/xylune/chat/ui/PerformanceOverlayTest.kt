...
class PerformanceOverlayTest {
    ...
    fun settingsAndRootContainDeveloperPerformanceWiring() {
        val settingsSource = java.io.File("src/main/java/app/xylune/chat/ui/SettingsScreen.kt").readText()
        val routeSource = java.io.File("src/main/java/app/xylune/chat/ui/SettingsRoute.kt").readText()
        val rootSource = java.io.File("src/main/java/app/xylune/chat/ui/XyluneApp.kt").readText()
        ...
        assertTrue(settingsSource.contains("github.com/omerfaruknehir/Xylune"))
        val home = settingsSource.substringAfter("private fun SettingsHome").substringBefore("private fun SettingsGroup")
        assertTrue(!home.contains("title = \"Developer settings\""))
        ...
        assertTrue(rootSource.contains("XylunePerformanceOverlay"))
    ...
    fun profilerWiringExistsAcrossSettingsRootChatAndBlur() {
        ...
        val blur = java.io.File("src/main/java/app/xylune/chat/ui/BackdropBlur.kt").readText()
        val overlay = java.io.File("src/main/java/app/xylune/chat/ui/PerformanceOverlay.kt").readText()
    ...
    fun profilerSeparatesDisplayCallbacksRenderedAndPresentedFrames() {
        val source = java.io.File("src/main/java/app/xylune/chat/ui/PerformanceOverlay.kt").readText()
    ...
    @Test
    fun xyluneDoesNotForceRefreshRateOrPerformanceClocks() {
    ...
    fun overlayIsVisualOnlyAndHasNoPointerConsumer() {
        val source = java.io.File("src/main/java/app/xylune/chat/ui/PerformanceOverlay.kt").readText()
        val function = source.substringAfter("internal fun XylunePerformanceOverlay(").substringBefore("private fun Double.f0")
