...
search = ROOT / "app/src/main/java/app/arbor/chat/ui/SearchScreen.kt"
search.write_text('''package app.arbor.chat.ui
...
''')
print("Corrected SearchScreen interaction and layout")
